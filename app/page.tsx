...
import { CRITERIA, CRITERION_TINY, STATE_LABEL, STATE_MARK, criteriaStateOf } from './data/criteria';
...
export default function Home(){
  ...
  const changeMode=(next:Mode)=>{
    ...
    // スマホでは選択肢が画面外に落ちやすいので、検証モードは全画面で開く
    if(next==='verify'&&typeof window!=='undefined'&&window.matchMedia('(max-width:800px)').matches)setFullscreen(true);
