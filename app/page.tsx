...
const MODES: { id: Mode; label: string; hint: string }[] = [
  ...
  { id: 'pressure', label: '中央集権型', hint: '入り口がひとつに寄った場合' },
  { id: 'open', label: '分散型', hint: '入り口が複数のまま残った場合' },
