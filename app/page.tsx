...
export default function Home(){
  ...
  const pointDetail=useMemo(()=>{
    ...
    return{name:CRITERION_NAME[shift.id],tiny:CRITERION_TINY[shift.id],effect:CRITERION_EFFECT[shift.id][shift.state],state:shift.state,count:pointMetrics[observedMessage.id]?.n??1};
